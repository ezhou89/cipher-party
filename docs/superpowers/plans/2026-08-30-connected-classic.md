...
- [x] **Step 6: Commit Task 2 after the repository gate**
...
- [x] **Step 1: Write failing distribution and determinism tests**
...
- [x] **Step 2: Run the board test and observe the missing function**
...
- [x] **Step 3: Implement a documented deterministic random source**
...
- [x] **Step 4: Implement Classic board creation**
...
- [x] **Step 5: Add property tests for invariant coverage**
...
- [x] **Step 6: Run focused and repository tests**
